...
namespace SingPlus\Support\Logs\Providers;

use Monolog\Logger as Monolog;
use Illuminate\Support\ServiceProvider;
use Illuminate\Log\Writer;

class TXIMServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->app->singleton('log.txim', function () {
    ...
    {
        $log->useFiles(
            $this->app->storagePath().'/logs/txim.log',
            $this->logLevel()
        );
    }
    ...
    {
        $log->useDailyFiles(
            $this->app->storagePath().'/logs/txim.log', $this->maxFiles(),
            $this->logLevel()
        );
    }
