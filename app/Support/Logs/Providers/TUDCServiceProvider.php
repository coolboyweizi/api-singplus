...
class TUDCServiceProvider extends ServiceProvider
{
    /**
    ...
    {
        $this->app->singleton('log.tudc', function () {
    ...
    {
        $log->useFiles(
            $this->app->storagePath().'/logs/tudc.log',
            $this->logLevel()
        );
    }
    ...
    {
        $log->useDailyFiles(
            $this->app->storagePath().'/logs/tudc.log', $this->maxFiles(),
            $this->logLevel()
        );
    }
