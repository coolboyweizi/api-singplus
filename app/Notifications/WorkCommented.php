...
class WorkCommented extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
      $this->type = NotificationConstant::TYPE_WORK_COMMENT;
      $this->data = $data;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      return (new FCMMessage())
        ...
        ->data([
          'type'  => NotificationConstant::TYPE_WORK_COMMENT,
        ]);
    }

    private function renderBody(array $data) : string
    {
      $res = view('notifications.workCommented', $data);
