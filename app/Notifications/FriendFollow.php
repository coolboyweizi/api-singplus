...
class FriendFollow extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
      $this->type = NotificationConstant::TYPE_FRIEND_FOLLOW;
      $this->data = $data;
    }
    ...
    {
      $res = view('notifications.friendFollow', $data);
