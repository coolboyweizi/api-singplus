...
class CoverOfDay extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TOPIC_TYPE_COVER_OF_DAY;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TOPIC_TYPE_COVER_OF_DAY,
    ...
    {
      $res = view('notifications.topicCoverOfDay', $data);
