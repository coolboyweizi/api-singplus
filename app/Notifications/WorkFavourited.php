...
class WorkFavourited extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
      $this->type = NotificationConstant::TYPE_WORK_FAVOURITE;
      $this->data = $data;
    }
    ...
    {
      $res = view('notifications.workFavourited', $data);
