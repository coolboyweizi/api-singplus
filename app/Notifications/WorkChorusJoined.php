...
class WorkChorusJoined extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
      $this->type = NotificationConstant::TYPE_WORK_CHORUS_JOIN;
      $this->data = $data;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      return (new FCMMessage())
        ...
        ->data([
          'type'  => NotificationConstant::TYPE_WORK_CHORUS_JOIN,
        ]);
    }

    private function renderBody(array $data) : string
    {
      $res = view('notifications.workChorusJoined', $data);
