...
class UserActive1st extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TYPE_USER_ACTIVE_1ST;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TYPE_USER_ACTIVE_1ST,
    ...
    {
      $res = view('notifications.userActive1st', $data);
