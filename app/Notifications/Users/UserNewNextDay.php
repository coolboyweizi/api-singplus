...
class UserNewNextDay extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TYPE_USER_NEW_NEXTDAY;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TYPE_USER_NEW_NEXTDAY,
    ...
    {
      $res = view('notifications.userNewNextDay', $data);
