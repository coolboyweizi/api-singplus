...
class UserNew7Day extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TYPE_USER_NEW_7DAY;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TYPE_USER_NEW_7DAY,
    ...
    {
      $res = view('notifications.userNew7Day', $data);
