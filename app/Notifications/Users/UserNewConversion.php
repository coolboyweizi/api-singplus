...
class UserNewConversion extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TYPE_USER_NEW_CONVERSION;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TYPE_USER_NEW_CONVERSION,
    ...
    {
      $res = view('notifications.userNewConversion', $data);
