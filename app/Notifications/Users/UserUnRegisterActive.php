...
class UserUnRegisterActive extends BaseNotification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(array $data = [])
    {
      ...
      $this->type = NotificationConstant::TYPE_USER_UNREGISTER_ACTIVE;
    }
    ...
    public function toFCM(Notifiable $notifiable)
    {
      ...
      $data = [
        ...
        'type'        => NotificationConstant::TYPE_USER_UNREGISTER_ACTIVE,
    ...
    {
      $res = view('notifications.userUnRegisterActive', $data);
