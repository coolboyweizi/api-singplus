 ...
 * Generated for Laravel 5.4.19 on 2018-07-16 09:16:24.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \SingPlus\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SingPlus\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SingPlus\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SingPlus\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SingPlus\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SingPlus\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SingPlus\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \SingPlus\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SingPlus\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \SingPlus\Console\Kernel::setArtisan($artisan);
        }
    ...
    class Auth {
         ...
         *
         * @return \SingPlus\Domains\Users\Models\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \SingPlus\Domains\Users\Models\User|false 
         * @static 
         */ 
         ...
         *
         * @return \SingPlus\Domains\Users\Models\User 
         * @static 
         */ 
...
namespace Laravel\Socialite\Facades { 
    ...
    class Socialite {
        ...
        {
            //Method inherited from \Laravel\Socialite\SocialiteManager            
            return \SingPlus\Support\Socialite\Manager::with($driver);
        }
        ...
        {
            //Method inherited from \Laravel\Socialite\SocialiteManager            
            return \SingPlus\Support\Socialite\Manager::buildProvider($provider, $config);
        }
        ...
        {
            //Method inherited from \Laravel\Socialite\SocialiteManager            
            return \SingPlus\Support\Socialite\Manager::formatConfig($config);
        }
        ...
        {
            //Method inherited from \Laravel\Socialite\SocialiteManager            
            return \SingPlus\Support\Socialite\Manager::getDefaultDriver();
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \SingPlus\Support\Socialite\Manager::driver($driver);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \SingPlus\Support\Socialite\Manager::extend($driver, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Support\Manager            
            return \SingPlus\Support\Socialite\Manager::getDrivers();
        }
...
namespace SingPlus\SMS\Facades { 
    ...
    class SMS {
         ...
         *
         * @param \SingPlus\SMS\Message $message message will be send
         * @param string $transport transport name
         * @static 
         */ 
        public static function send($message, $transport = null)
        {
            return \SingPlus\SMS\SMSer::send($message, $transport);
        }
         ...
         * @return \SingPlus\SMS\Transport 
         * @static 
         */ 
        public static function getTransport($transport = null)
        {
            return \SingPlus\SMS\SMSer::getTransport($transport);
        }
         ...
         * @static 
         */ 
        public static function genMessageBodyFromView($view, $data = array())
        {
            return \SingPlus\SMS\SMSer::genMessageBodyFromView($view, $data);
        }
...
namespace SingPlus\Support\Notification\Facades { 
    ...
    class Log {
        ...
        public static function emergency($message, $context = array())
        {
            \Illuminate\Log\Writer::emergency($message, $context);
        }
        ...
        public static function alert($message, $context = array())
        {
            \Illuminate\Log\Writer::alert($message, $context);
        }
        ...
        public static function critical($message, $context = array())
        {
            \Illuminate\Log\Writer::critical($message, $context);
        }
        ...
        public static function error($message, $context = array())
        {
            \Illuminate\Log\Writer::error($message, $context);
        }
        ...
        public static function notice($message, $context = array())
        {
            \Illuminate\Log\Writer::notice($message, $context);
        }
        ...
        public static function debug($message, $context = array())
        {
            \Illuminate\Log\Writer::debug($message, $context);
        }
...
namespace Stevebauman\Location\Facades { 
    ...
    class Location {
         ...
         * @static 
         */ 
        public static function get($ip = '', $cache = false)
        {
            return \SingPlus\Support\Locations\Location::get($ip, $cache);
        }
        ...
        {
            //Method inherited from \Stevebauman\Location\Location            
            return \SingPlus\Support\Locations\Location::setDriver($driver);
        }
        ...
        {
            //Method inherited from \Stevebauman\Location\Location            
            return \SingPlus\Support\Locations\Location::setDefaultDriver();
        }
        ...
        {
            //Method inherited from \Stevebauman\Location\Location            
            return \SingPlus\Support\Locations\Location::setSessionKey($key);
        }
...
namespace  { 
    ...
    class SMS extends \SingPlus\SMS\Facades\SMS {}

    class LogNotification extends \SingPlus\Support\Notification\Facades\Log {}

    class LogLocation extends \SingPlus\Support\Logs\Facades\Location {}

    class LogTUDC extends \SingPlus\Support\Logs\Facades\TUDC {}

    class LogReq extends \SingPlus\Support\Logs\Facades\Request {}

    class LogTXIM extends \SingPlus\Support\Logs\Facades\TXIM {}
